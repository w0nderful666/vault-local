...
async function checkDocs() {
  ...
  if (release.includes("v0.3.0")) pass("RELEASE_NOTES v0.3.0 exists");
  else fail("RELEASE_NOTES missing v0.3.0");

  if (pkg.version === "0.3.0") pass("package.json version is correct");
